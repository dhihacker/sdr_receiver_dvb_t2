...
//-------------------------------------------------------------------------------------------
HANDLE OpenOneDevice (_In_  HDEVINFO HardwareDeviceInfo,
...
--*/
{
    HANDLE hDEV = OpenUsbDevice( (LPGUID)&GUID_CLASS_USBSAMP_USB, completeDeviceName);
...
--*/
{
    ...
    h = CreateFileA(completeDeviceName,
...
//-------------------------------------------------------------------------------------------
BOOL compare_buffs(_In_reads_bytes_(length) char *buff1,
...
//-------------------------------------------------------------------------------------------
int main_(_In_ int   argc, _In_reads_(argc) char *argv[])
/*++
Routine Description:
